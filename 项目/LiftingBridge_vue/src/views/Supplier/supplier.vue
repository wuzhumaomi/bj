  ...
  <div class="administrator-list project-tasks">
    <el-form ref="query" :model="query" :inline="true" label-width="100px" label-position="right">
      <div class="queryContent">
        <!--供应商表示用编号-->
        <el-form-item :label="$t('supplier.supplierCdDis')" class="form-item">
          <el-input v-model="query.supplierCdDis" clearable>
          </el-input>
        </el-form-item>
        <!--供应商名称-->
        <el-form-item :label="$t('supplier.supplierNm')" class="form-item">
          <el-input v-model="query.supplierNm" clearable />
        </el-form-item>
        <!--供应商简称-->
        <el-form-item :label="$t('supplier.supplierJc')" class="form-item">
          <el-input v-model="query.supplierJc" clearable />
        </el-form-item>
        <!--英文名称-->
        <el-form-item :label="$t('supplier.supplierNmEn')" class="form-item">
          <el-input v-model="query.supplierNmEn" clearable/>
        </el-form-item>
        <!--供应商种类-->
        <el-form-item :label="$t('supplier.supplierType')" class="form-item">
          <el-select v-model="query.supType" clearable>
            <el-option v-for="item in supType"  :key="item.id" :label="item.value" :value="item.id"/>
          </el-select>  
        </el-form-item>
        <!--评价等级-->
        <el-form-item :label="$t('supplier.levelId')" class="form-item">
          <el-select v-model="query.levelId" clearable>
            <el-option v-for="item in levelId"  :key="item.id" :label="item.value" :value="item.id"/>
          </el-select>
        </el-form-item>
        <!--国家-->
        <el-form-item :label="$t('supplier.cntryCd')" class="form-item">
          <el-select v-model="query.cntryCd" clearable>
            <el-option v-for="item in cntryCd"  :key="item.id" :label="item.value" :value="item.code"/>
          </el-select>
        </el-form-item>
        <!--结算方式-->
        <el-form-item :label="$t('supplier.paymentType')" class="form-item" prop="paymentType">
    ...
    <el-table :data="list"  style="width: 100%"  class="operationCss" @row-dblclick="supplierEdit()" v-loading="listLoading" border>
      <el-table-column :label="$t('supplier.supplierCdDis')" prop="supplierCdDis" width='100px'/>
