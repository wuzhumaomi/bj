<template>
    ...
    <div>
      <el-row :gutter="24">
        <el-col :span="24">
          <el-form class="tasks-addEditor" ref="MyaddEditorRef"  :model="MyData" :rules="rules"   label-position="right" label-width="120px" size="mini">
            <el-card shadow="never">
              <el-row :gutter="20">
                <el-col :span="12">
                  <div class="grid-content bg-purple">
                    <el-form-item  :label="$t('organizatDepartment.center')" prop="proId">
                    ...
                    <el-form-item  :label="$t('organizatDepartment.organizatDepartmentCode')" prop="taskNm">
                        <el-input  clearable v-model="MyData.taskNm" :placeholder="$t('placeholders.content')"  maxlength="20"/>
                    </el-form-item>
                    <el-form-item  :label="$t('organizatDepartment.epistaticCoding')" prop="taskNm">
                        <el-input  clearable v-model="MyData.taskNm" :placeholder="$t('placeholders.content')"  maxlength="20"/>
                    </el-form-item>
                  </div>
                </el-col>
                <el-col :span="12">
                  <div class="grid-content bg-purple">
                    <el-form-item :label="$t('organizatDepartment.organizatDepartmentName')" prop="receiver">
                      <el-input  clearable v-model="MyData.taskNm" :placeholder="$t('placeholders.content')"  maxlength="20"/>
                    </el-form-item>
                    <el-form-item :label="$t('organizatDepartment.meansCodedOrganizat')" prop="personLiable">
                      <el-input  clearable v-model="MyData.taskNm" :placeholder="$t('placeholders.content')"  maxlength="20"/>
                    </el-form-item>
                  </div>
                </el-col>
